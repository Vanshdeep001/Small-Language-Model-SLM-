#!/usr/bin/env python3
"""
Windows-Compatible Small Language Model (SLM) Training Script
...
if __name__ == '__main__':
    ...
    plt.ylabel("Loss")
    plt.title("Windows SLM Training and Validation Loss")
    plt.legend()
    plt.grid(True)
    plt.savefig('windows_training_losses.png')
    plt.show()
    ...
    print("\n" + "="*60)
    print("WINDOWS SLM INFERENCE RESULTS")
    print("="*60)
    ...
    print("\n" + "="*60)
    print("WINDOWS TRAINING COMPLETED SUCCESSFULLY!")
    print(f"Best model saved as: {best_model_params_path}")
    print(f"Training plot saved as: windows_training_losses.png")
